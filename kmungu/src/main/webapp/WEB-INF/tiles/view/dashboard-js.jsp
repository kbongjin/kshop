<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
    ...
    <!-- jQuery Sparklines -->
    <script src="${res}/vendors/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
    <!-- Flot -->
    ...
    <!-- Flot plugins -->
    <script src="${res}/js/flot/jquery.flot.orderBars.js"></script>
    <script src="${res}/js/flot/date.js"></script>
    <script src="${res}/js/flot/jquery.flot.spline.js"></script>
    <script src="${res}/js/flot/curvedLines.js"></script>
    <!-- bootstrap-daterangepicker -->
    <script src="${res}/js/moment/moment.min.js"></script>
    <script src="${res}/js/datepicker/daterangepicker.js"></script>
