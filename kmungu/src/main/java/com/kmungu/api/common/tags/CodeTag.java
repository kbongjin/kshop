...
package com.kmungu.api.common.tags;
...
import com.kmungu.api.code.CommonCodeService;
...
public class CodeTag extends TagSupport {
	...
	protected static CommonCodeService codeHandler;
	...
	public String makeTag()throws Exception{
		...
		List<CommonCode> list = codeHandler.getCodes(this.group_id, this.except_cds);
	...
	public int doEndTag() throws JspException {
		try{
	        ...
	        if(codeHandler == null){
	            codeHandler = applicationContext.getBean(CommonCodeService.class);
	        }
